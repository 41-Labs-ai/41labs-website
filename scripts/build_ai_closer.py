                    ...
                    <div id="cl-step2" hidden>
                        <div id="cl-book" hidden>
                            ...
                            <div id="cl-handoff" hidden>
                                <p class="handoff-lead"><b>Last step.</b> Message our own AI Closer. Your answers are already in the message, so it picks up from there. You get to watch it work on your way to the call.</p>
                                <a class="btn btn-primary" id="cl-wa-handoff" href="https://wa.me/6580124848" target="_blank" rel="noopener">Message now <span class="arrow">&rarr;</span></a>
                            </div>
